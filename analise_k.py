...
for c, p in enumerate(porcentagem):
    ...
    for i in np.arange(25)+1:
        ...
        dados = pd.read_csv('D:/Drive UFRN/Doutorado/Resultados/Artigo GRRS/Analise K/resultado_150k'+str(i)+'.csv')
